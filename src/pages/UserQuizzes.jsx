...
function UserQuizzes() {
  ...
  return (
    <div className=" bg-gradient-to-br from-indigo-950 to-indigo-900 min-h-screen flex flex-col justify-center items-center relative overflow-hidden">
      ...
      <div className="mb-80 relative z-10 max-w-6xl w-full mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <button 
          onClick={() => navigate(-1)}
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          ...
          <button
            ...
            className="inline-flex items-center px-5 py-2.5 bg-purple-600 text-white text-sm font-semibold rounded-lg shadow-md hover:bg-purple-700 transition duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 z-20 relative"
            type="button"
          >
